...
@section('page_title')
All Accounts | DashLite Admin Template
@endsection
@section('content')
                ...
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">All Accounts</h3>
                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools justify-between g-3">
                                         <li>
                                      <!-- <a href="#" class="btn btn-white btn-outline-light"><em class="icon ni ni-upload-cloud"></em><span>Order List</span></a></li>
                                         <li> -->
      ...
      <table class="datatable-init nowrap table">
        <thead class="tb-odr-head">
          <tr class="tb-odr-item">
             ...
             <th class="tb-odr-amount">
               <span class="tb-odr-total">Account Id</span>
              </th>
              <th class="tb-odr-amount">
               <span class="tb-odr-total">Account Type</span>
              </th>  
              <th class="tb-odr-amount">
               <span class="tb-odr-total">Particular</span>
              </th> 
          ...
          <tr class="tb-odr-item">
              <td class="tb-odr-amount">
               <span class="tb-odr-total">
                <span class="amount">Cash in hand</span>
                </span>
               </td>
               <td class="tb-odr-amount">
               <span class="tb-odr-total">
         ...
         <tr class="tb-odr-item">
              <td class="tb-odr-amount">
               <span class="tb-odr-total">
                <span class="amount">Bank Asia #345</span>
                </span>
               </td>
               <td class="tb-odr-amount">
               <span class="tb-odr-total">
               ...
               <td class="tb-odr-amount">
               <span class="tb-odr-total">
                <span class="amount">Cash at hand</span>
                </span>
               </td>
             <td class="tb-odr-action">
              <div class="tb-odr-btns d-none d-sm-inline">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md">
                <h5 class="modal-title">Add Head of Accounts Information</h5>
