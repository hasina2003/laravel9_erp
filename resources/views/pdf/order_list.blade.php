...
@section('page_title')
Order List | DashLite Admin Template
@endsection
                                        ...
                                        <div class="invoice-wrap">
                                            ...
                                            <div class="invoice-head">
                                                <div class="invoice-contact">
                                                    <span class="overline-title">Customer: </span>Customer-1
                                               ...
                                               <div class="col-md-4">
                                                ...
                                                <div class="invoice-desc">
                                                    ...
                                                    <ul class="list-plain">
                                                        ...
                                                        <li class="invoice-id"><span>Total Quantity</span>:<span>2</span></li>
                                                         <li class="invoice-id"><span>Total Price</span>:<span>5000</span></li>
