...
@section('page_title')
Production List | DashLite Admin Template
@endsection
                                               ...
                                               <div class="col-md-4">
                                                ...
                                                <div class="invoice-desc">
                                                    ...
                                                    <ul class="list-plain">
                                                        ...
                                                        <li class="invoice-id"><span>Total Order Quantity</span>:<span>2</span></li>
                                                        <li class="invoice-id"><span>Ready Quantity</span>:<span>0</span></li>
