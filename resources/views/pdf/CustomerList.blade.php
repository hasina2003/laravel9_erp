...
@section('page_title')
Customer List | DashLite Admin Template
@endsection
                                            ...
                                            <div class="invoice-bills">
                                                <div class="table-responsive">
                                                    <table class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th class="w-150px">Customer Id</th>
                                                                 <th class="w-150px">Customer Name</th>
                                                                 <th class="w-150px">Phone</th>
                                                                 <th class="w-150px">Email</th>
                                                                  <th class="w-150px">Address</th>
                                                                  <th class="w-150px">Account No.</th>
                                                                  <th class="w-150px">Account Type</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
