...
@section('page_title')
Income Statement | DashLite Admin Template
@endsection
@section('content')
                ...
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Income Statement</h3>
                                    ...
                                    <ul class="nk-block-tools justify-between g-3">
                                     ...
                                     <div class="form-group">
                                      <label class="form-label">End Date</label>
                                       ...
                                       <a href="{{route('income.list')}}" class="btn btn-white btn-outline-light"><em class="icon ni ni-upload-cloud"></em><span>Income List</span></a></li>
                                         <li> 
