...
@section('page_title')
All Item | DashLite Admin Template
@endsection
@section('content')
                ...
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">All Item</h3>
                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools justify-between g-3">
                                        <li><a href="#" class="btn btn-white btn-outline-light"><em class="icon ni ni-upload-cloud"></em><span>Item List</span></a></li>
                     ...
                     <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                                ...
                                <a href="{{ route('item.category') }}"><em class="icon ni ni-plus"></em></a>
                                <div class="form-control-wrap">
                        ...
                        <div class="col-md-4">
                         <div class="form-group">
                                ...
                                <a href="{{ route('item.color') }}"><em class="icon ni ni-plus"></em></a>
                                <div class="form-control-wrap">
                                  <select name="cust_id" id="cust_id" class="form-control">
                                     <option disabled="" selected="">select</option>
                        ...
                        <div class="col-md-6">
                         <div class="form-group">
                                ...
                                <a href="{{ route('item.type') }}"><em class="icon ni ni-plus"></em></a>
                                <div class="form-control-wrap">
                                  <select name="cust_id" id="cust_id" class="form-control">
                                     <option disabled="" selected="">select</option>
                         ...
                         <div class="col-md-6">
                          <div class="form-group">
                                ...
                                <a href="{{ route('item.size') }}"><em class="icon ni ni-plus"></em></a>
                                <div class="form-control-wrap">
                                    <select name="cust_id" id="cust_id" class="form-control">
                                     <option disabled="" selected="">select</option>
