...
@section('page_title')
All Designation | DashLite Admin Template
                ...
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Designation Information</h3>
                            <div class="nk-block-des text-soft">
                                <!-- <p>You have total 937 Designation Information.</p> -->
                            </div>
        ...
        <thead class="tb-odr-head">
          <tr class="tb-odr-item">
             <th class="tb-odr-amount">
               <span class="tb-odr-total">Designation</span>
              </th>
             ...
             <tr class="tb-odr-item">
              <td class="tb-odr-amount">
               <span class="tb-odr-total">
                <span class="amount">{{ $designationdata-> designation_name}}</span>
                </span>
               </td>
             <td class="tb-odr-action">
              <div class="tb-odr-btns d-none d-sm-inline">
               <!-- <a href="">
                ...
                <a href="{{route('designation.editdata',$designationdata->id)}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
               </svg>
                </a>||
               <a href="{{route('designation.deletedata',$designationdata->id)}}">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md">
                ...
                <form action="{{route('designation.save')}}" class="mt-2" method="POST">
                    @csrf
                    <div class="col-md-12">
