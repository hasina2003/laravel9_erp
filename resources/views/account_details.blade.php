...
@section('page_title')
Account Details | DashLite Admin Template
@endsection
@section('content')
                ...
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Account Details</h3>
        ...
        <thead class="tb-odr-head">
          <tr class="tb-odr-item">
             ...
             <th class="tb-odr-amount">
              ...
              <th class="tb-odr-amount">
               <span class="tb-odr-total">Bank Name</span>
              </th>  
         ...
         <tr class="tb-odr-item">
              <td class="tb-odr-amount">
               ...
               <td class="tb-odr-amount">
               <span class="tb-odr-total">
                <span class="amount">Islami Bank</span>
                </span>
               </td>
