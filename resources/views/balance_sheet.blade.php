...
@section('page_title')
Balance Sheet | DashLite Admin Template
@endsection
@section('content')
                ...
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Balance Sheet</h3>
                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control date-picker" name="leave_from">
                                       ...
                                       <a href="{{route('balance.statement')}}" class="btn btn-white btn-outline-light"><em class="icon ni ni-upload-cloud"></em><span>Balance Sheet</span></a></li>
                                         <li> 
        ...
        <thead class="tb-odr-head">
          <tr class="tb-odr-item">
             ...
             <th class="tb-odr-amount">
               ...
               <th class="tb-odr-amount">
               	<span class="tb-odr-total">Debit</span>
              </th> 
              <th class="tb-odr-amount">
               <span class="tb-odr-total">Credit</span>
              </th> 
         ...
         <tbody class="tb-odr-body">
          <tr class="tb-odr-item">
               ...
               <span class="tb-odr-total">
                <span class="amount">20th January,2023</span>
                </span>
               </td>
              <td class="tb-odr-amount">
               <span class="tb-odr-total">
         ...
         <tr class="tb-odr-item">
          	  <td class="tb-odr-amount">
               <span class="tb-odr-total">
                <span class="amount">14th March,2023</span>
                </span>
               </td>
              <td class="tb-odr-amount">
               <span class="tb-odr-total">
          ...
          <tr class="tb-odr-item">
          	  <td class="tb-odr-amount">
               <span class="tb-odr-total">
                <span class="amount">Net Amount : 95,000 Tk.</span>
                </span>
               </td>
              <td class="tb-odr-amount">
               <span class="tb-odr-total">
